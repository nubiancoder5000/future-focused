...
function AboutContent({heading, imgSrc, paragraph,vidSrc}) {
  return (
  <div className="about__content--container  flex flex-wrap bg-[#0463ef] lg:items-center first:mt-24 lg:p-0 p-12 items-center justify-center lg:even:flex-row-reverse lg:even:h-[600px]">
